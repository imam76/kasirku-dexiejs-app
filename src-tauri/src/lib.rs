...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::workforce_commands::postgres_finalize_leave_request,
            commands::workforce_commands::postgres_list_workforce_state,
            commands::workforce_commands::postgres_upsert_work_schedule_template_bundle,
            commands::workforce_commands::postgres_upsert_employee_work_schedule_assignment,
            commands::workforce_commands::postgres_upsert_company_calendar_day,
            commands::workforce_commands::postgres_upsert_leave_type,
            commands::workforce_commands::postgres_upsert_leave_balance_ledger,
            commands::workforce_commands::postgres_upsert_leave_workflow,
            commands::workforce_commands::postgres_cancel_approved_leave_request,
            commands::workforce_commands::postgres_resolve_collection_coverage,
            commands::hr_commands::postgres_list_hr_positions,
            commands::hr_commands::postgres_upsert_hr_position,
            commands::hr_commands::postgres_list_employment_contracts,
            commands::hr_commands::postgres_upsert_employment_contract,
            commands::hr_commands::postgres_list_salary_components,
            commands::hr_commands::postgres_upsert_salary_component,
            commands::hr_commands::postgres_list_employee_salary_components,
            commands::hr_commands::postgres_upsert_employee_salary_component,
            commands::inventory_lot_commands::postgres_list_inventory_lots,
            commands::inventory_lot_commands::postgres_upsert_inventory_lot,
            commands::inventory_lot_commands::postgres_list_inventory_lot_consumptions,
            commands::inventory_lot_commands::postgres_upsert_inventory_lot_consumption,
            ...
            commands::budget_commands::postgres_list_budgets,
            commands::budget_commands::postgres_get_budget,
            commands::budget_commands::postgres_upsert_budget,
            commands::budget_commands::postgres_delete_budget,
            commands::budget_commitment_commands::postgres_list_budget_commitments,
            commands::budget_commitment_commands::postgres_get_budget_commitment,
            commands::budget_commitment_commands::postgres_upsert_budget_commitment,
            commands::budget_commitment_commands::postgres_delete_budget_commitment,
            ...
            commands::pos_stock_discrepancy_commands::postgres_list_pos_stock_discrepancies,
            commands::pos_stock_discrepancy_commands::postgres_get_pos_stock_discrepancy,
            commands::pos_stock_discrepancy_commands::postgres_upsert_pos_stock_discrepancy,
            ...
            commands::transaction_commands::postgres_list_transaction_bundles,
            commands::transaction_commands::postgres_get_transaction_bundle,
            commands::transaction_commands::postgres_upsert_transaction_bundle,
            commands::promo_commands::postgres_list_promos,
            commands::promo_commands::postgres_get_promo,
            commands::promo_commands::postgres_upsert_promo,
            commands::promo_commands::postgres_delete_promo,
            commands::lottery_commands::postgres_list_lotteries,
            commands::lottery_commands::postgres_get_lottery,
            commands::lottery_commands::postgres_upsert_lottery,
            commands::lottery_commands::postgres_delete_lottery,
            ...
            commands::purchase_cost_reconciliation_commands::postgres_list_purchase_cost_reconciliation_bundles,
            commands::purchase_cost_reconciliation_commands::postgres_get_purchase_cost_reconciliation_bundle,
            commands::purchase_cost_reconciliation_commands::postgres_upsert_purchase_cost_reconciliation_bundle,
