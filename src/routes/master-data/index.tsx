...
function MasterData() {
  ...
  const menuItems: MasterDataMenuItem[] = [
    ...
    { to: '/master-data/lotteries', label: t('nav.lotteries'), icon: GiftOutlined, color: 'text-purple-600', desc: t('home.lotteriesDesc') },
    { to: '/master-data/contacts', label: t('nav.contacts'), icon: ContactsOutlined, color: 'text-amber-600', desc: t('home.contactsDesc') },
    { to: '/master-data/memberships', label: t('nav.memberships'), icon: IdcardOutlined, color: 'text-indigo-600', desc: t('home.membershipsDesc') },
    ...
    { to: '/master-data/restaurant-tables', label: t('nav.restaurantTables'), icon: TableOutlined, color: 'text-orange-600', desc: t('restaurantTables.homeDescription') },
