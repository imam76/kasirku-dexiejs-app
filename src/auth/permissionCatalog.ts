...
export const PERMISSION_CATALOG: PermissionCatalogItem[] = [
  ...
  },
  {
    ...
    label: 'HR - Lihat Karyawan',
    description: 'Melihat daftar dan detail non-payroll karyawan.',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE'],
  },
  {
    code: 'hr.employee.create',
    label: 'HR - Tambah Karyawan',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE'],
    isSensitive: true,
  },
  {
    ...
    label: 'HR - Ubah Karyawan',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE'],
    isSensitive: true,
  },
  {
    code: 'hr.employee.deactivate',
    label: 'HR - Ubah Status Aktif Karyawan',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE'],
    isSensitive: true,
  },
  {
    ...
    label: 'HR - Kelola Organisasi',
    description: 'Mengelola departemen dan jabatan.',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE', 'DEPARTMENT'],
    isSensitive: true,
  },
  {
    code: 'hr.contract.manage',
    label: 'HR - Kelola Kontrak',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE'],
    isSensitive: true,
  },
  {
    ...
    label: 'HR - Lihat Data Penggajian',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE', 'CASH_FLOW'],
    isSensitive: true,
  },
  {
    code: 'hr.payroll.manage',
    label: 'HR - Kelola Data Penggajian',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE', 'CASH_FLOW'],
    isSensitive: true,
  },
  {
    code: 'hr.schedule.manage',
    label: 'HR - Kelola Jadwal Kerja',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE'],
    isSensitive: true,
  },
  {
    code: 'hr.leave.self_service',
    label: 'HR - Pengajuan Cuti Sendiri',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE'],
  },
  {
    code: 'hr.leave.supervisor_approve',
    label: 'HR - Approval Cuti Atasan',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE'],
    isSensitive: true,
  },
  {
    code: 'hr.leave.hr_approve',
    label: 'HR - Approval Final Cuti',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE'],
    isSensitive: true,
  },
  {
    code: 'hr.leave.policy.manage',
    label: 'HR - Kelola Kebijakan Cuti',
    group: 'Human Resources',
    moduleCodes: ['EMPLOYEE'],
    isSensitive: true,
  },
  ...
  {
    code: 'cooperative.collection.assignment.manage',
    label: 'Koperasi - Kelola Penugasan Penagihan',
    group: 'Koperasi',
    moduleCodes: ['KOPERASI_PENAGIHAN', 'KOPERASI_ANGGOTA'],
    isSensitive: true,
  },
  {
    code: 'cooperative.collection.coverage.manage',
    label: 'Koperasi - Kelola Pengganti Penagihan',
    group: 'Koperasi',
    moduleCodes: ['KOPERASI_PENAGIHAN'],
    isSensitive: true,
  },
