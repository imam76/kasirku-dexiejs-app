...
import { Alert, App, Button, Descriptions, Select, Space, Table, Tag, Typography } from 'antd';
...
import type { ChartOfAccountTemplatePreview } from '@/services/chartOfAccountService';
        ...
        <div className="rounded-md border border-gray-100 p-4">
          ...
          <Descriptions size="small" column={2} className="mt-4">
            ...
            <Descriptions.Item label={t('coa.template.missingAccounts')}>
              {templatePreview?.missingAccounts.length ?? 0}
            </Descriptions.Item>
            <Descriptions.Item label={t('coa.template.mappingChanges')}>
              {templatePreview?.mappingChangeCount ?? 0}
            </Descriptions.Item>
            <Descriptions.Item label={t('coa.template.moduleChanges')}>
              {templatePreview?.moduleChangeCount ?? 0}
            </Descriptions.Item>
          </Descriptions>
          <Space wrap className="mt-3">
            ...
            <Button
              ...
              disabled={selectedProfile !== 'SAK_EMKM' || selectedExtension !== 'RETAIL'}
            >
        ...
        <div className="rounded-md border border-gray-100 p-4">
          ...
          <Space wrap>
            {moduleRows.map((module) => (
              <Tag key={module.key} color={module.enabled ? 'green' : 'default'}>
                {module.label}
              </Tag>
            ))}
          </Space>
