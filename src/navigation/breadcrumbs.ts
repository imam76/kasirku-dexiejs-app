...
const STATIC_LABEL_KEYS: Record<string, TranslationKey> = {
  ...
  '/finance': 'nav.finance',
  '/hr': 'nav.hr',
  '/hr/dashboard': 'hr.dashboard.title',
  '/hr/employees': 'hr.employees.title',
  '/hr/departments': 'hr.departments.title',
  '/hr/positions': 'hr.positions.title',
  '/hr/contracts': 'hr.contracts.title',
  '/hr/salary-components': 'hr.salaryComponents.title',
  ...
  '/master-data/memberships': 'nav.memberships',
  ...
  '/master-data/restaurant-tables': 'nav.restaurantTables',
  '/master-data/employees': 'nav.employees',
  '/master-data/users': 'nav.users',
