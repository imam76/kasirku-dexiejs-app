...
export const FINANCE_CATEGORIES = {
  ...
  CUSTOMER_CREDIT_REFUND: 'PENGEMBALIAN_LEBIH_BAYAR_PELANGGAN',
  PURCHASE_INVOICE_PAYMENT: 'PEMBAYARAN_INVOICE_PEMBELIAN',
  SALES_REFUND: 'REFUND_PENJUALAN',
  CASH_BANK_TRANSFER: 'TRANSFER_KAS_BANK',
  CASH_BANK_RECONCILIATION_GAIN: 'SELISIH_LEBIH_REKONSILIASI_KAS_BANK',
  CASH_BANK_RECONCILIATION_LOSS: 'SELISIH_KURANG_REKONSILIASI_KAS_BANK',
...
export const COOPERATIVE_ONLY_FINANCE_CATEGORIES = [
  ...
  FINANCE_CATEGORIES.KSP_LOAN_ADMIN_FEE,
...
export const NON_PROFIT_FINANCE_CATEGORIES = [
  ...
  FINANCE_CATEGORIES.CUSTOMER_CREDIT_REFUND,
...
export const isCooperativeOnlyFinanceCategory = (category: string) => {
  return COOPERATIVE_ONLY_FINANCE_CATEGORIES.includes(
    category as typeof COOPERATIVE_ONLY_FINANCE_CATEGORIES[number],
  );
};
