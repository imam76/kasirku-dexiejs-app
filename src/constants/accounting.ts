...
export const ACCOUNTING_MODULE_ACTIVATION_RULES: AccountingModuleActivationRule[] = [
  ...
  },
  {
    ...
    requires_confirmation: false,
    requires_data_safety_check: false,
    description: 'General ledger double-entry otomatis aktif setelah setup akuntansi awal.',
    created_at: '',
    updated_at: '',
  },
  {
  ...
  },
  {
    ...
    requires_confirmation: false,
    requires_data_safety_check: false,
    description: 'General ledger double-entry koperasi otomatis aktif setelah setup akuntansi awal.',
    created_at: '',
    updated_at: '',
  },
];
