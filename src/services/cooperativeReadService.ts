...
const mapRemoteCooperativeMemberToLocal = (
  ...
  collection_schedule_id: optionalString(remoteMember.collection_schedule_id),
  collection_weekday: remoteMember.collection_weekday ?? undefined,
  collection_assignment_needs_review: remoteMember.collection_assignment_needs_review ?? false,
