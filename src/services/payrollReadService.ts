...
const mapRemotePayrollRunToLocal = (
  ...
  payroll_period: remoteRun.payroll_period ?? 'MONTHLY',
  salary_currency: optionalString(remoteRun.salary_currency) ?? 'IDR',
...
const mapRemotePayrollRunItemToLocal = (
  ...
  employee_number: optionalString(remoteItem.employee_number),
  employee_position: optionalString(remoteItem.employee_position),
  employee_department: optionalString(remoteItem.employee_department),
  payroll_period: remoteItem.payroll_period ?? 'MONTHLY',
  salary_currency: optionalString(remoteItem.salary_currency) ?? 'IDR',
  salary_payment_method: remoteItem.salary_payment_method ?? 'CASH',
