...
const buildSalesReturnDraft = async (
  ...
  const salesReturn: SalesReturn = {
    ...
    tax_flow: source.tax_flow,
    tax_account_id: source.tax_account_id,
    tax_account_code: source.tax_account_code,
    tax_account_name: source.tax_account_name,
    tax_account_type: source.tax_account_type,
