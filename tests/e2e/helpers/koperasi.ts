 ...
 * "Input Saldo Awal Pinjaman" menu. Picks a free past disbursement date before today and lets
 * the form snap the official schedule to the officer's collection weekday, so the migration posts no journal.
